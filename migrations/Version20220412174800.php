 ...
 */
final class Version20220412174800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP INDEX UNIQ_E00CEDDE8565851, ADD INDEX IDX_E00CEDDE8565851 (establishment_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE booking DROP INDEX IDX_E00CEDDE8565851, ADD UNIQUE INDEX UNIQ_E00CEDDE8565851 (establishment_id)');
