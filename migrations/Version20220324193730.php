 ...
 */
final class Version20220324193730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gallery (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(100) NOT NULL, lien VARCHAR(255) NOT NULL, taille NUMERIC(10, 2) NOT NULL, slug VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
